...
# Re-test knobs: every herd-growth experiment before v14 was run while
# the shed was serialised to one unit per turn, so extra hands could not
# reach it and simply idled. Those results are artefacts of that
# bottleneck and are being re-measured on top of v14.
PLACEMENT_DUTY = False
HIRE_WINDOW_HOURS = 0
HIRE_COST_CEILING = 10**9
